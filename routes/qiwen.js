    ...
    var request = http.get(options, function (response) {
        ...
        response.on("end", function (err) {
            ...
            for (var i=0;i<data.newslist.length;i++){
                ...
                var  userAddSql_Params = [newslist.title,newslist.description,newslist.picUrl,newslist.url];
                var  userAddSql = 'INSERT INTO qiwen(title,description,picUrl,url) VALUES(?,?,?,?)';
